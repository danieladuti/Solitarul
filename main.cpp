...
int culoareFundal= COLOR(222, 202, 24), culoarePiesa=RED, culoareTabla= BLACK;
...
void reguli_joc()
{
    ...
    settextstyle(3,HORIZ_DIR,1);
    setcolor(LIGHTBLUE);
    outtextxy(10,130,"-> Se foloseste o tabla patrata cu gauri sau spatii libere initial ocupate de piese.");
    outtextxy(10,160,"-> Dimensiunea tablei poate varia, insa o varianta obisnuita este tabla de 7x7.");
    settextstyle(10,HORIZ_DIR,3);
    setcolor(BLUE);
    outtextxy(10,190,"2. SCOPUL JOCULUI:");
    settextstyle(3,HORIZ_DIR,1);
    setcolor(LIGHTBLUE);
    outtextxy(10,220,"-> Elimina piesele de pe tabla prin sarituri peste acestea, pana cand ramane doar o singura piesa in mijlocul");
    outtextxy(10,250,"tablei.");
    outtextxy(10,280,"-> Scopul este sa elimini cat mai multe piese posibil, avand grija sa nu lasi piese izolate, care nu pot fi eliminate.");
    settextstyle(10,HORIZ_DIR,3);
    setcolor(BLUE);
    outtextxy(10,310,"3. MISCARI POSIBILE:");
    settextstyle(3,0,1);
    setcolor(LIGHTBLUE);
    outtextxy(10,340,"-> Piesele se misca prin sarituri peste alte piese, similar cu miscarea unei dame in jocul de dame.");
    outtextxy(10,370,"-> O piesa poate sa sara peste o piesa adiacenta orizontal sau vertical (nu diagonal) pe o pozitie libera, astfel");
    outtextxy(10,400,"eliminand piesa pe care a sarit-o.");
    settextstyle(10,HORIZ_DIR,3);
    setcolor(BLUE);
    outtextxy(10,430,"4. FINALUL JOCULUI:");
    settextstyle(3,HORIZ_DIR,1);
    setcolor(LIGHTBLUE);
    outtextxy(10,460,"-> Pierzi atunci cand nu mai poti face nicio miscare valida si ai eliminat toate piesele posibile,");
    outtextxy(10,490,"sau castigi cand ramane doar o singura piesa in mijlocul tablei.");
